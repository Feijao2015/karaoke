          ...
          <div className="grid gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Ex: D:/KARAOKEV3/sounds/high-score.mp3"
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="medium-score-sound">Som para Nota Média (81-90)</Label>
              <Input
                id="medium-score-sound"
                type="text"
                value={settings.soundEffects.medium || ''}
                onChange={(e) => handleSoundPathChange('medium', e.target.value)}
                placeholder="Ex: D:/KARAOKEV3/sounds/medium-score.mp3"
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="low-score-sound">Som para Nota Baixa (0-80)</Label>
              <Input
                id="low-score-sound"
                type="text"
                value={settings.soundEffects.low || ''}
                onChange={(e) => handleSoundPathChange('low', e.target.value)}
                placeholder="Ex: D:/KARAOKEV3/sounds/low-score.mp3"
              />
            </div>
